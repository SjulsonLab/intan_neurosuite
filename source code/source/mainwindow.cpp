...
void MainWindow::scanPorts()
{
    ...
    if (!synthMode) {
        ...
        setWindowTitle(tr("Intan Technologies RHD2000 Interface, Neuroscope-compatible edition"));
    } else {
...
void MainWindow::about()
{
    QMessageBox::about(this, tr("About Intan Technologies RHD2000 Interface"),
            tr("<h2>Intan Technologies RHD2000 Interface</h2>"
               ...
               "<p>This version of the software was modified for Neuroscope compatibility by "
               "Luke Sjulson. Contact lukesjulson@gmail.com for any questions."
